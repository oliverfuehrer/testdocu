...
[mermaid, c4-component, format={mermaid-format}]
----
C4Component
...
== C4 Dynamic Diagram
[mermaid, c4-dynamic, format={mermaid-format}]
----
C4Dynamic
  title Checkout Flow
  Person(user, "User")
...
[mermaid, c4-deployment, format={mermaid-format}]
----
C4Deployment
...
== Sequence Diagram
[mermaid, sequence, format={mermaid-format}]
----
sequenceDiagram
  actor User as User
...
== Flowchart
[mermaid, flowchart, format={mermaid-format}]
----
flowchart TD
...
== Gantt Chart
[mermaid, gantt, format={mermaid-format}]
----
gantt
...
== Pie Chart
[mermaid, pie, format={mermaid-format}]
----
pie
...
== State Diagram
[mermaid, state, format={mermaid-format}]
----
stateDiagram-v2
  [*] --> Idle
  Idle --> Loading : Start
...
[mermaid, er, format={mermaid-format}]
----
erDiagram
